%{!?prefix: %global prefix /opt/dview}
...
sudo echo "export FrontEndDir=/opt/dview/node-express-react" >> /etc/profile
source /etc/profile

# -- symbolic links
echo '>>> create symbolic links for mongodb and node ... '
# sudo ln -s /opt/dview/mongodb-linux-x86_64-rhel70-3.6.4/* %{localbin} -f
sudo ln -s /opt/dview/node-v8.11.1-linux-x64/bin/* %{localbin} -f
